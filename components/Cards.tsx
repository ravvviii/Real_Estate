      ...
      <Text className='text-xs font-rubik-bold text-primary-300 ml-1'>{item.rating}</Text>
            ...
            <View className='flex flex-col item-start absolute bottom-5 inset-x-5'>
                ...
                <View className='flex flex-row items-center justify-between w-full mt-2'>
                    <Text className='text-xl font-rubik-extrabold text-white' >₹ {formatIndianCurrency(item.price)}</Text>
      ...
      <Text className='text-xs font-rubik-bold text-primary-300 ml-0.5'>{item.rating}</Text>
            ...
            <View className='flex flex-col mt-2'>
                ...
                <View className='flex flex-row items-center justify-between  mt-2'>
                    <Text className='text-base font-rubik-bold text-primary-300' >₹ {formatIndianCurrency(item.price)}</Text>
